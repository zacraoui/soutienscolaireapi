            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        <div class="mt-1 small text-muted"> @can('dashboard-admin') Administrateur @elsecan('dashboard-teacher') {{ Auth::user()->civilite == 'Mr' ? 'Professeur' : 'Professeure' }} @elsecan('dashboard-student') Étudiant  @endcan</div>
                    </div>
                </a>
