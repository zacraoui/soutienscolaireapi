                                ...
                                @foreach($users as $user)
                                    ...
                                    <td data-label="Name" >
                                        <div class="d-flex py-1 align-items-center">
                                            <span class="avatar me-2" style="background-image: url({{ asset('files/images/'.$user->photo_profil) }})"></span>
                                            <div class="flex-fill">
                                                <div class="font-weight-medium">{{ $user->civilite .'. '. $user->nom. ' '.$user->prenom  }}</div>
                                                <div class="text-muted">{{ $user->email }}</div>
                                                <div class="text-muted">{{ isset($user->enseignant->cin) ? $user->enseignant->cin : '' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td data-label="Title" >
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            @if(isset($user->enseignant->status) && !$user->enseignant->status)
