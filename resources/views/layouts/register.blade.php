...
<div class="container">
    <ul class="steps" id="layout-etudiant-not-payed">
        <li id="add-compte" class="{{ (isset($step) && $step >= 1 ) ? 'active' : $step }}">
            <div>
                <span></span>
                <span></span>
                <span></span>
        ...
        <li id="info_personnel" class="{{ (isset($step) && ($step >= 2  )) ? 'active' : $step }}">
            <div>
                <span></span>
                <span></span>
                <span></span>
        ...
        <li id="info_professionnelle" class="{{ (isset($step) && ($step >= 3  )) ? 'active' : $step }}">
            <div>
                <span></span>
                <span></span>
                <span></span>
        ...
        <li id="info_matiere" class="{{ (isset($step) && ($step >= 4  )) ? 'active' : $step }}">
            <div>
                <span></span>
                <span></span>
                <span></span>
                ...
                <span></span>
                <span></span>
                <span>Matière et Niveau</span>
            </div>
        </li>
        <li id="info_matiere" class="{{ (isset($step) && ($step >= 5  )) ? 'active' : $step }}">
            <div>
                <span></span>
                <span></span>
                <span></span>
